...
let a = 0;
newItems = [];
pobieraniePrzedmiotow();

function pobieraniePrzedmiotow()
{
...
function pokazKoszyk()
{
    ...
    if(document.getElementById("PodsumowanieZamowienia").style.display != "none")
    {
        document.getElementById("PodsumowanieZamowienia").style.display = "none"
        document.getElementById("podsumowanie3").style.display = "none"
    }
...
function rozwijanieKup()
{
    let Przycisk = document.getElementById("przyciskKup")
    Przycisk.classList.add('przyciskKupRozwiniety')
    Przycisk.classList.remove('przyciskKup')
    Przycisk.textContent = "Zakupiono"
    Przycisk.onanimationend = function()
    {
        Przycisk.classList.add('przyciskKup')
        Przycisk.classList.remove('przyciskKupRozwiniety')
        Przycisk.textContent = "Kup"
        Oproznij();
    }
}
...
function przejdzDoAdresu()
{
    document.getElementById("Koszyk2").style.display = "none";
    document.getElementById("podsumowanie1").style.display = "none";
    document.getElementById("Dane").style.display = "grid";
    document.getElementById("PodsumowanieZamowienia").style.display = "none";
    document.getElementById("podsumowanie3").style.display = "none";
...
function idzDoPodsumowania()
{
    document.getElementById("PodsumowanieZamowienia").style.display = "inline-flex";
    document.getElementById("podsumowanie3").style.display = "inline-flex";
    document.getElementById("Dane").style.display = "none";
    let htmlCode2 = 
    `
    <table style="max-width: 80%;">
    ...
    for(let i = 0; i < Basket.length; i++)
    {
        if(Basket[i] != 0)
        {
            ...
            <tr>
                <td class = "Nazwa" style = "width : 50%"> ${items[i].Name}</td>
                <td class = "Nazwa" align="center" style = "width : 18%">${items[i].Price}</td>
                <td class = "Nazwa" align="center" style = "width : 12%"> ${Basket[i]} </td>
                <td align = "center" class = "Nazwa" id = "SumaB ${i}" style = "width : 20%">${(items[i].Price * Basket[i]).toFixed(2)}</td>
            </tr>
            `
        }
    ...
    document.querySelector(".PodsumowanieZamowienia").innerHTML = htmlCode2;
    document.getElementById("sumakoszyka3").textContent = SumaKoszyka.toFixed(2)
}
...
/*
        <header data-thq="thq-navbar" class="navbar-interactive">
            ...
            <div style=" width: 25%; height: 30px; color: aqua;" id ="Navbardiv"></div>
